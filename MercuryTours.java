...
public class MercuryTours 
{
	...
	public static void main(String[] args) throws InterruptedException 
	{
		...
		wd.get("http://demo.guru99.com/test/newtours/index.php");
		wd.manage().window().maximize();
		
		//REGISTER
		wd.findElement(By.linkText("REGISTER")).click();
		wd.findElement(By.name("firstName")).sendKeys("Ankita");
		wd.findElement(By.name("lastName")).sendKeys("Thamke");
		wd.findElement(By.name("phone")).sendKeys("9819798427");
		...
		wd.findElement(By.name("email")).sendKeys("Ankita");
		...
		//LOGIN
		wd.findElement(By.name("userName")).sendKeys("Ankita");
		wd.findElement(By.name("password")).sendKeys("12345");
		wd.findElement(By.name("submit")).click();
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		wd.findElement(By.xpath("//tbody/tr[2]/td[2]/b[1]/font[1]/input[2]")).click();
		...
		wd.findElement(By.xpath("//tbody/tr[9]/td[2]/font[1]/font[1]/input[1]")).click();
		...
		System.out.println("FIND FLIGHTS:No seats available");
		...
		//SELENIUM 
		wd.findElement(By.xpath("//body/div[1]/div[2]/nav[1]/div[1]/div[1]/ul[1]/li[1]/a[1]")).click(); 
		wd.findElement(By.linkText("Flash Movie Demo")).click();
		wd.findElement(By.xpath("//body/form[1]/center[1]/input[1]")).click();
		wd.findElement(By.xpath("//body/form[1]/center[1]/input[2]")).click();
		wd.findElement(By.xpath("//body/form[1]/center[1]/input[3]")).click();
		wd.findElement(By.xpath("//body/form[1]/center[1]/input[4]")).click();
		wd.navigate().back();
		Thread.sleep(1000);
		...
		wd.findElement(By.xpath("//tbody/tr[2]/td[2]/input[1]")).sendKeys("1234");
		...
		wd.findElement(By.xpath("//input[@id='uploadfile_0']")).sendKeys("C:\\Users\\Akshay\\Desktop\\");
		Thread.sleep(2000);
		...
		Thread.sleep(1000);
		wd.findElement(By.xpath("//input[@id='email']")).sendKeys("Ankita@gmail.com");
		wd.findElement(By.xpath("//input[@id='passwd']")).sendKeys("12345");
		wd.findElement(By.xpath("//body/div[@id='page']/div[1]/div[1]/div[2]/div[1]/div[1]/div[1]/form[1]/div[1]/p[2]/button[1]/span[1]")).click();
		wd.navigate().back();
		wd.navigate().back();
		...
		Thread.sleep(1000);
		wd.findElement(By.xpath("//input[@id='photoimg']")).sendKeys("G:\\Ankita\\Important Documents");
		...
		wd.findElement(By.xpath("//body/div[2]/form[1]/input[1]")).sendKeys("Ankita@gmail.com");
		wd.findElement(By.xpath("//body/div[2]/form[1]/input[2]")).sendKeys("12345");
		...
		WebElement drag1=wd.findElement(By.xpath("//body/section[@id='g-container-main']/div[1]/div[1]/main[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/ul[1]/li[2]/a[1]"));
		...
		WebElement drag3=wd.findElement(By.xpath("//body/section[@id='g-container-main']/div[1]/div[1]/main[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/ul[1]/li[4]/a[1]"));
		...
		Thread.sleep(2000);
		wd.findElement(By.xpath("//body/form[1]/input[1]")).sendKeys("21-09-2023");
		//wd.findElement(By.xpath("//body/form[1]/input[1]")).sendKeys("02:20 PM");
		wd.findElement(By.xpath("//body/form[1]/input[2]")).click();
		wd.navigate().back();
		...
		wd.findElement(By.name("email")).sendKeys("Ankita@gmail.com");
		wd.findElement(By.name("password")).sendKeys("12345");
		...
		Thread.sleep(2000);
		wd.findElement(By.xpath("//body/div[3]/div[1]/div[2]/form[1]/div[8]/input[1]")).click();
		wd.findElement(By.name("submit")).click();
		wd.navigate().back();
		Thread.sleep(2000);
		...
		wd.findElement(By.xpath("//tbody/tr[5]/td[2]/input[1]")).sendKeys("Ankita@gmail.com");
		wd.findElement(By.name("btnLogin")).click();
		...
		wd.findElement(By.name("name")).sendKeys("Ankita");
		wd.findElement(By.xpath("//tbody/tr[5]/td[2]/input[2]")).click();
		...
		wd.findElement(By.name("emailid")).sendKeys("Ankita@gmail.com");
		wd.findElement(By.name("sub")).click();
		Thread.sleep(2000);
		wd.navigate().back();
//		wd.findElement(By.linkText("Edit Customer")).click();
//		wd.findElement(By.xpath("//tbody/tr[6]/td[2]/input[1]")).sendKeys("335931");
//		wd.findElement(By.xpath("//tbody/tr[11]/td[2]/input[1]")).click();
//		wd.findElement(By.linkText("Delete Customer")).click();
//		wd.findElement(By.xpath("//tbody/tr[2]/td[2]/input[1]")).sendKeys("335931");
//		wd.findElement(By.xpath("//tbody/tr[7]/td[2]/input[1]")).click();
//		wd.findElement(By.linkText("New Account")).click();
//		wd.findElement(By.xpath("//tbody/tr[2]/td[2]/input[1]")).sendKeys("335931");
//		Select s35=new Select(wd.findElement(By.xpath("//tbody/tr[2]/td[2]/input[1]")));
//		s35.selectByVisibleText("savings");
//		wd.findElement(By.xpath("//tbody/tr[4]/td[2]/input[1]")).sendKeys("20000");
//		wd.findElement(By.xpath("//tbody/tr[5]/td[2]/input[1]")).click();
//		wd.findElement(By.linkText("Edit Account")).click();
//		wd.findElement(By.xpath("//tbody/tr[6]/td[2]/input[1]")).sendKeys("2549");
//		wd.findElement(By.xpath("//tbody/tr[11]/td[2]/input[1]")).click();
//		wd.findElement(By.linkText("Delete Account")).click();
//		wd.findElement(By.xpath("//tbody/tr[6]/td[2]/input[1]")).sendKeys("2549");
//		wd.findElement(By.xpath("//tbody/tr[11]/td[2]/input[1]")).click();
//		wd.findElement(By.linkText("Mini Statement")).click();
//		wd.findElement(By.xpath("//tbody/tr[6]/td[2]/input[1]")).sendKeys("2541");
//		wd.findElement(By.xpath("//tbody/tr[11]/td[2]/input[1]")).click();
...
//		
		...
		Select s28=new Select(wd.findElement(By.xpath("//tbody/tr[6]/td[2]/select[1]")));
		...
		wd.findElement(By.name("fname")).sendKeys("Ankita");
		wd.findElement(By.name("lname")).sendKeys("Thamke");
		wd.findElement(By.name("emailid")).sendKeys("Ankita@gmail.com");
		wd.findElement(By.name("addr")).sendKeys("Kalyan");
		wd.findElement(By.name("telephoneno")).sendKeys("9819798427");
		wd.findElement(By.name("submit")).click();
		System.out.println("Access Details to Guru99 Telecom");
		wd.findElement(By.xpath("//body/section[@id='main']/div[1]/div[1]/ul[1]/li[1]/a[1]")).click();
		...
		Thread.sleep(1000);
		wd.findElement(By.xpath("/html/body/section/div/ul/li/a")).click();
		wd.findElement(By.linkText("Add Tariff Plan to Customer")).click();
		wd.findElement(By.name("customer_id")).sendKeys("335931");
		wd.findElement(By.name("submit")).click();
		System.out.println("Welcome to add customer tariff plan Ankita");
		Thread.sleep(1000);
		//wd.findElement(By.xpath("//tbody/tr[1]/td[1]/label[1]")).click();
		wd.findElement(By.name("submit")).click();
		System.out.println("Congratulation Tariff Plan assigned");
		wd.findElement(By.xpath("//body/section[@id='main']/div[1]/ul[1]/li[1]/a[1]")).click();
		wd.findElement(By.linkText("Pay Billing")).click();
		wd.findElement(By.name("customer_id")).sendKeys("335931");
		wd.findElement(By.name("submit")).click();
		System.out.println("Pay billing page is displayed");
		wd.findElement(By.xpath("//body/span[@id='header']/nav[1]/a[1]")).click();
		wd.findElement(By.xpath("//body/nav[@id='menu']/ul[1]/li[1]/a[1]")).click();
		...
		wd.findElement(By.xpath("//body/section[@id='three']/div[1]/form[1]/div[1]/div[8]/ul[1]/li[1]/input[1]")).click();
		...
		//SEO
		wd.findElement(By.xpath("//body/div[1]/div[2]/nav[1]/div[1]/div[1]/ul[1]/li[11]/a[1]")).click();
